    ...
    <div className="bg-primary  pt-40 pb-10 md:pb-20 flex flex-col items-center justify-center">
      <div className="flex flex-col items-center justify-center gap-4 px-4">
        <div className="flex items-center justify-center text-white font-poppins text-2xl/8 md:text-5xl md:leading-[-1] line lg:text-6xl font-bold text-center">
          Empower Your Institution with EduZenix
        </div>
        <div className="text-zinc-500 text-sm  md:text-2xl lg:w-4/5 flex items-center justify-center text-center font-poppins py-2 px-4">
          Modernize admissions, automate hostels, streamline academics — all in
          one ERP platform.
        </div>
      </div>
      {/* Cards */}
      <div className="flex flex-col xl:flex-row items-center justify-center pt-10 gap-10 w-full px-4 lg:px-0 xl:w-2/3">
        <div className="border p-4 rounded-lg text-center xl:text-start border-sky-300/30 w-full md:w-3/5  transition-shadow duration-300 hover:shadow-md hover:shadow-sky-400/40">
